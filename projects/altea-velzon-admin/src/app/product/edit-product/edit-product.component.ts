...
export class EditProductComponent extends NgEditBaseComponent<Product> implements OnInit {
  ...
  productResourcePropsToUpdate = ['offset', 'duration', 'resourceId', 'idx', 'durationMode', 'reference', 'scheduleIds', 'groupQty', 'groupAlloc', 'prep', 'prepOverlap', 'flex', 'flexAfter', 'optionDur', 'optionIds', 'back']
  ...
  override async ngOnInit() {
    ...
    this.sectionProps.set('general', ['name', 'short', 'slug', 'url', 'descr', 'inform', 'salesPrice', 'vatPct', 'color', 'personSelect', 'staffSelect', 'priceFrom', 'priceInfo', 'type', 'sub', 'minQty', 'maxQty'])
